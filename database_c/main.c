...
uint32_t* internal_ndoe_right_child(void* node) {
...
/*
 Until we starting recycling free pages, new pages will always
...
void create_new_root(Table* table, uint32_t right_child_page_num) {
  ...
  *internal_node_child(node, 0) = left_child_page_num;
